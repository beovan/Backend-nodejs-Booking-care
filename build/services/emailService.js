                ...
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    transporter = _nodemailer["default"].createTransport({
                      ...
                      port: 587,
                      secure: false,
                      //true for 465 port, false for other ports
                      auth: {
                        user: process.env.EMAIL_APP,
...
var sendForgotPasswordEmail = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(dataSend) {
    var transporter, info;
  ...
  return function sendForgotPasswordEmail(_x5) {
    return _ref4.apply(this, arguments);
  };
}();
var getForgotPasswordEmail = function getForgotPasswordEmail(dataSend, resetUrl) {
  var result = "";
  result = "\n    <h3>Xin ch\xE0o ".concat(dataSend.firstName, "!</h3>\n<p> \n\u0110\xE3 nh\u1EADn \u0111\u01B0\u1EE3c y\xEAu c\u1EA7u thay \u0111\u1ED5i m\u1EADt kh\u1EA9u cho t\xE0i kho\u1EA3n  c\u1EE7a b\u1EA1n.\n</p>\n<p> \u0110\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u N\u1EBFu b\u1EA1n kh\xF4ng th\u1EF1c hi\u1EC7n y\xEAu c\u1EA7u n\xE0y, vui l\xF2ng b\u1ECF qua.\n</p>\n\n<div>\n<a href=\"").concat(resetUrl, "\">Click here to reset your password</a>\n</div>\n<div>Xin c\u1EA3m \u01A1n</div>\n    ");
  return result;
};
module.exports = {
