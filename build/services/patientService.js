...
var buildUrlEmail = function buildUrlEmail(doctorId, token) {
  var result = "".concat(process.env.URL_REACT, "/verify-booking?doctorId=").concat(doctorId, "&token=").concat(token);
  return result;
};
var buildUrlEmailResetPassword = function buildUrlEmailResetPassword(userId, token) {
  ...
  var result = "".concat(process.env.URL_REACT, "/reset-password?userId=").concat(userId, "&token=").concat(token);
  return result;
};
...
var createNewPatient = function createNewPatient(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var check, islogin, hashPasswordFromBcrypt, newUser, userInfo;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            _context5.next = 9;
            return _userService["default"].handleGoogleLogin({
              uid: data.uid,
              email: data.email
            });
          case 9:
          ...
          case 19:
            _context5.t0 = null;
          case 20:
            hashPasswordFromBcrypt = _context5.t0;
            _context5.next = 23;
          ...
          case 23:
            ...
            if (newUser) {
              userInfo = newUser.dataValues; // Access the created user data
...
var getBookingByUserId = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(user) {
  ...
  return function getBookingByUserId(_x15) {
